...
//            // Xử lý khi bấm nút "Buy Ticket"
//            StringBuilder seatList = new StringBuilder("Selected: ");
//            for (Button btn : selectedSeats) {
//                seatList.append(btn.getText()).append(" ");
//            }
//            tvTotalPrice.setText(seatList.toString() + "\nTotal: " + selectedSeats.size() * seatPrice + " VND");
//        });
//    }
//
